...
export const osaamismerkkiTeemaNimi = createNimi('Testautomation osaamismerkkiteema');
export const osaamismerkkiNimi = createNimi('Testautomation osaamismerkki');
...
export async function tarkistaJulkisivuNakyvyys(page) {
